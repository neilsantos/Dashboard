...
namespace Dashboard
{
    class Program
    {
        ...
        //    foreach (var listarmarca in repositorioMarcas.Ler())
        //    {
        ...
        private static void CadastrarProduto(IEnumerable<Marca> marcas , List<Categoria> categorias, List<Produto> inventario)
        {
            Console.Clear();
        ...
        private static Marca LerMarca(IEnumerable<Marca> marcas)
        {
            var eValido = true;
            int idMarca;
        ...
        private static void Deletar(IEnumerable<Marca> marcas)
        {
            if (!marcas.Any())
            {
                Console.WriteLine("Nenhum item em categoria");
        ...
        private static void Atualizar(IEnumerable<Marca> marcas)
        {
            if (!marcas.Any())
            {
                Console.WriteLine("Primeiro faça o cadastro");
        ...
        private static void Atualizar(List<Produto> inventario, IEnumerable<Marca> marcas)
        {
            if (!inventario.Any())
            {
                Console.WriteLine("Primeiro faça o cadastro");
        ...
        private static void AtualizarProduto(Produto item)
        {
            Console.WriteLine("Informe o Novo nome: ");
            string novoNome = Console.ReadLine();
            Console.WriteLine("Atualizar:\n");
        ...
        private static void EditarAcessorios(IEnumerable<Marca> marcas, Produto item)
        {
            if (!item.Acessorios.Any())
            {
                Console.WriteLine("Não Há Acessorios Cadastrados");
        ...
        private static void AdicionarAcessorios(IEnumerable<Marca> marcas, Produto item)
        {
